...
local plugins = {
  ...
  -- { Using Telescope now. Much better.
  --   "nvim-tree/nvim-tree.lua",
  --   opts = overrides.nvimtree,
  -- },

  { -- One of the simplest and most useful plugin
  ...
  -- -- NOT USED: Kinda funny to see that I've said it was so useful.
  ...
  -- -- We already have copilot. Just use chatgpt from the browser
  -- {
  --   "sourcegraph/sg.nvim",
  --
  ...
  -- { -- Useful but I don't use it somehow. (Kinda ditched coding a bit.)
  --   "danymat/neogen",
  --   dependencies = "nvim-treesitter/nvim-treesitter",
  --   config = function(_, opts)
  ...
  { -- Useful but not using. Just use your lovely formatter.
    "Wansmer/treesj",
