...
(setq user-full-name "Orhan KARAMAN"
...
(setq doom-theme 'doom-tomorrow-night
      doom-font (font-spec :family "Cozette" :size 10)
      doom-variable-pitch-font (font-spec :family "Cozette" :size 10))
...
;;; :completion corfu
;; IMO, modern editors have trained a bad habit into us all: a burning need for
;; completion all the time -- as we type, as we breathe -- but how often do you
;; *really* need that information? I say rarely. So opt for manual completion:
(after! corfu
  (setq corfu-auto nil))
